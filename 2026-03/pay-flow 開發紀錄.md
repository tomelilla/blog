...
公司每個月要手動算薪資，依據一份 Excel 總表（`115年睿星智宇員工薪資總表.xlsx`），  
裡面記錄了每個員工當月的：底薪、出勤天數、請假扣款、勞健保、獎金、加班費……

**老闆的原始需求只有一句話：**

> 「我不想每個月手動填 Excel，可以做個工具嗎？」
...
> 用 AI 開發，不是把問題丟進去等答案出來。  
> 而是和一個非常快、記憶力很好、但偶爾會鬧烏龍的工程師合作。  
> **你的角色是 tech lead，你要審查、要測試、要發現問題。**
